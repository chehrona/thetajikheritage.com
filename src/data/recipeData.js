module.exports.recipes = [
    ...
    // },
    {
        ...
        history: {
            us: {
                desc: {
                    ...
                    tooltip2: {
                        word: `sheep tail fat`,
                        text: `Mainly in Sa&shymar&shykand, Bu&shykha&shyra, Fer&shyga&shyna and Northern Tajikistan`
                    },
                    text3: `.<sup>2</sup>
                        Also, shirchoy is occasionally known by dif&shyfer&shyent names that highlight ad&shydi&shytion&shyal in&shygre&shydi&shyents beyond tea and milk. 
                        Since it is pre&shydom&shyi&shynant&shyly a salty dish, it is alternatively called <span class='termSpan'>"shürchoy,"</span> derived from the Tajiki word for salty, "shür."
                        ...
                        it can be clas&shysi&shyfied as a milk-based "soup" mainly served in bowls or deep wooden plates.<br>
            ...
            ru: {
                desc: {
                    text1: `<span class='termSpan'>Ширчой</span> — традиционное блюдо, которое готовят в разных странах Центральной Азии и Ближного Востока, в том числе в Тад&shyжикистане. Его название «ширчой» 
                        ...
                        быть кусочки лепёшки (обыч&shyно используется черствый хлеб), сливочное или топ&shyлёное масло, кусочки сушёных яб&shyлок, шелковица, листья мин&shyда&shyля, грецкие орехи и цветки шиповника.<sup>2,4</sup> 
                        Ширчой мо&shyжет включать нетрадиционные ин&shyгре&shyди&shyен&shyты для блюда на основе молока, например не&shyболь&shyшое количество перца (приправы), `,
                        tooltip1: {
                            word: `кусочки сырого лука`,
                            text: `Только в Самарканде`
                        },
                        text2: ` или даже растопленый `,
                        tooltip2: {
                            word: ` курдючный жир`,
                            text: `В основном в Самарканде, Бухаре, Фергане и Северном Таджикистане`
                        },
                        text3: `.<sup>2</sup>
            ...
            tj: {
                desc: {
                    text1: `<span class='termSpan'>Ширчой</span> таомест, ки дар кишварҳои мух&shyта&shyли&shyфи Осиёи Миёнаю Шарқи Наздик ва ҳам&shyчу&shyнин 
                        ...
                        маска ё равғани зар&shyди сӯхта, бу&shyри&shyда&shyҳои се&shyби хушк, тут, барг&shyҳои бо&shyдом, чор&shyмағз ва гул&shyҳои хуч (ши&shyпов&shyник)-&shyро дар бар гиранд.<sup>2,4</sup> 
                        Ба ширчой баъзан чизҳои барои хӯрокҳои ширӣ ғайриоддӣ, аз монанди мурч, `,
                    tooltip1: {
                        word: `резаҳои пиёз`,
                        text: `Танҳо дар Самарқанд`,
                    },
                    text2: ` ва ҳатто равғани `,
                    tooltip2: {
                        word: `думбаи обкардашуда`,
                        text: `Асосан дар Самарқанд, Бухоро, Фарғона ва вилояти Суғд`,
                    },
                    text3: `, андохта мешаванд.
                            Ин&shyчу&shyнин, ширчой бо номҳои гуногун ҳам маъруф аст, ки онҳо аз яке аз маҳсулотҳои ило&shyва&shyги&shyаш гирифта мешаванд. Азбаски шир&shyчой одатан як хӯроки шӯр аст, 
                            яке аз ном&shyҳои дигараш <span class='termSpan'>«шӯрчой»</span> мебошад. Дар вилояти Бадахшон як намуди бо&shyлаз&shyза&shyти шир&shyчой — <span class='termSpan'>«ғӯзширчой»</span> омода карда 
                            ме&shyша&shyвад, ки яке аз қисмҳои асосии он чормағзи тафтдодашудаи кӯфта мебошад.<sup>4</sup>
                            Но&shyмаш аз ка&shyли&shyмаи шуғ&shyнии <span class='termSpan'>«ғӯз» [ɣůz]</span> гирифта шу&shyда&shyаст, ки маънояш «чормағз» мебошад.<sup>5</sup><br>
                            Тар&shyки&shyби шир&shyчой аз обу ҳавои минтақа ва хоҳиши пазанда вобастагӣ дорад. Масалан, мардуми кӯҳистон аксар вақт ба он равған ё қаймоқ илова мекунанд, чунки 
                            ...
                            Ҷолиб он аст, ки ширчой бо вуҷуди як хӯ&shyро&shyки моеъ буданаш, он&shyро ода&shyтан бо даст ме&shyхӯ&shyранд. Пораҳои нони дар шир тар шударо бо 
                            даст гирифта ис&shyтеъ&shyмол мекунанд ва моеъи боқимондаро аз коса менӯшанд.<sup>6</sup> Бо ин роҳ, нон ҳамчун асбоби хӯрокхурӣ ва ҳам ка&shyло&shyри&shyяи иловагӣ хидмат мекунад. Аҳолии 
                            шаҳр ширчойро бисёртар дар фасли зи&shyмис&shyтон истеъмол мекунад, ва&shyле ҷа&shyмо&shyат&shyҳои кӯҳӣ, ба мисли помириҳо, аз сабаби муҳити ба&shyланд&shyкӯ&shyҳи&shyашон аз он тамоми сол ва дар 
                            як рӯз чанд ма&shyро&shyти&shyба лаз&shyзат мебаранд.<sup>2,4</sup>`
                }
            }
        },
        link: '/shirchoy',
        ...
        references: {
            us: [
                    {name: 'Vozeh, Qori Rahmatullo. کان لذت و خان نعمت [Source of pleasure and table spread of blessings]. <span style="font-style: italic">In Tajiki w. Perso-Arabic script. </span>Bukhara. 1880 - 1881.', link: ""},
                    ...
                    {name: 'van Oudenhoven, Frederik and Haider, Jamila. With Our Own Hands: A Celebration of Food and Life in the Pamir Mountains of Afghanistan and Tajikistan. <span style="font-style: italic">In English, Tajiki and Dari. </span>LM Publishers, 2015, p. 599.', link: ""},
